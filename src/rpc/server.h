...
/**
 * OCASHCOIN RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzocashseed(const UniValue& params, bool fHelp);
extern UniValue getzocashseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzocash(const UniValue& params, bool fHelp);
extern UniValue dzocashstate(const UniValue& params, bool fHelp);
