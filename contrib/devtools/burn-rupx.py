...
"""
burn-ocash: create a bitcoin burn address
By James C. Stroud
...
class BurnocashError(Exception):
    pass


class AlphabetError(BurnocashError):
    pass
...
def usage():
    print "usage: burn-ocash TEMPLATE"
    print
