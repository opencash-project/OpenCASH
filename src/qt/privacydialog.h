...
public:
    ...
    void setZ0cashControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzOCASH_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzOCASH_clicked();
    void on_pushButtonZ0cashControl_clicked();
