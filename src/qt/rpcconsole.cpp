                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzOCASHPathCustom = GetArg("-zocashbackuppath", "");
    ...
    if(!strzOCASHPathCustom.empty()) {
        ui->wallet_customzocashbackuppath->setText(QString::fromStdString(strzOCASHPathCustom));
        ui->wallet_customzocashbackuppath_label->setVisible(true);
        ui->wallet_customzocashbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzOCASHPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the OpenCASH RPC console.") + "<br>" +
