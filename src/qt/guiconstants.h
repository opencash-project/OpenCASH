...
/* OpenCASH GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "OCASHCOIN"
#define QAPP_ORG_DOMAIN "ocash.io"
#define QAPP_APP_NAME_DEFAULT "OCASHCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "OCASHCOIN-Qt-testnet"
