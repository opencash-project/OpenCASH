...
RESOURCES += src/qt/opencash.qrc src/qt/opencash_locale.qrc

TRANSLATIONS += src/qt/locale/opencash_bg.ts \
                src/qt/locale/opencash_de.ts \
                src/qt/locale/opencash_en.ts \
                src/qt/locale/opencash_es.ts \
                src/qt/locale/opencash_fi.ts \
                src/qt/locale/opencash_fr.ts \
                src/qt/locale/opencash_it.ts \
                src/qt/locale/opencash_ja.ts \
                src/qt/locale/opencash_pl.ts \
                src/qt/locale/opencash_pt.ts \
                src/qt/locale/opencash_ru.ts \
                src/qt/locale/opencash_sk.ts \
                src/qt/locale/opencash_sv.ts \
                src/qt/locale/opencash_vi.ts \
                src/qt/locale/opencash_zh_CN.ts \
                src/qt/locale/opencash_zh_TW.ts
