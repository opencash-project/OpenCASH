...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OpenCASH Core opencash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  opencash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded opencash transaction") + "\n" +
                               "  opencash-tx [options] -create [commands]   " + _("Create hex-encoded opencash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded opencash transaction
