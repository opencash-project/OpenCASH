...
In order to support loading of multiple wallets in opencash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is opencash.cpp.
...
Changes to opencash.cpp
----------------------
opencash.cpp is the entry point into opencash-qt, and as such, will require some minor modifications to provide hooks for
