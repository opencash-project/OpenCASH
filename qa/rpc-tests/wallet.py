...
#   c) node1 mines 32 blocks, so now node 0 has 60001ocash, node 1 has 4250ocash, node2 has none.
#   d) node0 sends 601 ocash to node2, in two transactions (301 ocash, then 300 ocash).
