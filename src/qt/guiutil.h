...
/** Utility functions used by the OCASHCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render OCASHCOIN addresses in monospace font
...
// Parse "opencash:" URI into recipient object, return true on successful parsing
