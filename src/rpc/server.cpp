...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop OCASHCOIN server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "OCASHCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OCASHCOIN features */
        {"opencash", "masternode", &masternode, true, true, false},
        {"opencash", "listmasternodes", &listmasternodes, true, true, false},
        {"opencash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"opencash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"opencash", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"opencash", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"opencash", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"opencash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"opencash", "masternodedebug", &masternodedebug, true, true, false},
        {"opencash", "startmasternode", &startmasternode, true, true, false},
        {"opencash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"opencash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"opencash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"opencash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"opencash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"opencash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"opencash", "mnbudget", &mnbudget, true, true, false},
        {"opencash", "preparebudget", &preparebudget, true, true, false},
        {"opencash", "submitbudget", &submitbudget, true, true, false},
        {"opencash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"opencash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"opencash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"opencash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"opencash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"opencash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"opencash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"opencash", "checkbudgets", &checkbudgets, true, true, false},
        {"opencash", "mnsync", &mnsync, true, true, false},
        {"opencash", "spork", &spork, true, true, false},
        {"opencash", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzocashseed", &getzocashseed, false, false, true},
        {"zerocoin", "setzocashseed", &setzocashseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzocash", &searchdzocash, false, false, true},
        {"zerocoin", "dzocashstate", &dzocashstate, false, false, true}
...
{
    return "> opencash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:43800/\n";
}
