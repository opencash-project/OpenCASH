...
#ifndef OCASHCOIN_ZOCASHTRACKER_H
#define OCASHCOIN_ZOCASHTRACKER_H
...
public:
    CzOCASHTracker(std::string strWalletFile);
    ~CzOCASHTracker();
...
#endif //OCASHCOIN_ZOCASHTRACKER_H
