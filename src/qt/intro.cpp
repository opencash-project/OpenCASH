...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("OpenCASH Core"),
     ...
     * override -datadir in the opencash.conf file in the default data directory
     * (to be consistent with opencashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
